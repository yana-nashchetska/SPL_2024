...
class ArtGenerator:
    ...
    def generate(self):
        ...
        base_height = 5
        max_chars_per_line = self.width // 6
        ...
        for line in wrapped_text:
            ...
            # Вирівнювання рядків ASCII-арту
        ...
        if self.color_mode == "gray":
            ascii_art_lines = [line.replace(self.symbol, '\033[90m' + self.symbol + '\033[0m') for line in ascii_art_lines]
