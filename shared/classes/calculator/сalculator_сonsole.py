...
from shared.classes.calculator.сonsole_reader import ConsoleReader
from shared.classes.calculator.calculator import Calculator
from shared.classes.calculator.console_writer import ConsoleWriter
